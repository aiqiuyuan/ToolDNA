...
def compute_score(data_source: str, solution_str: str, ground_truth: str, extra_info: Dict = None) -> float:
    ...
    DEBUG_LOG_PATH = "/mnt/bn/motor-nlp-team/users/aiqiuyuan/verl_debug/debug_records/debug_records_0708_human_description_ablation_new_reward_2.jsonl"
    SCORE_LOG_PATH = "/mnt/bn/motor-nlp-team/users/aiqiuyuan/verl_debug/score_records/score_records_0708_human_description_ablation_new_reward_2.jsonl"
    ...
    if (format_score == 1.0 and solution_tool_format_score == 1.0 and tool_name_score > 0.0 and param_name_score > 0.0 and param_value_score > 0.0):
        ...
        resolution = 0.0
    total_new = (format_score - 1) + tool_score*0.5 + resolution *0.5
