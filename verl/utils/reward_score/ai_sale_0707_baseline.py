...
def compute_score(data_source: str, solution_str: str, ground_truth: str, extra_info: Dict = None) -> float:
    ...
    DEBUG_LOG_PATH = "/mnt/bn/motor-nlp-team/users/aiqiuyuan/verl_debug/debug_records/debug_records_0708_human_baseline_simple_reward_llama_1.jsonl"
    SCORE_LOG_PATH = "/mnt/bn/motor-nlp-team/users/aiqiuyuan/verl_debug/score_records/score_records_0708_human_baseline_simple_reward_llama_1.jsonl"
    ...
    total_new = (format_score - 1) + tool_score
